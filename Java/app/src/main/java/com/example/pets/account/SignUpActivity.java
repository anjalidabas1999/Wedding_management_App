...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void setUp() {
        ...
        nameTextInputLayout = findViewById(R.id.signUpActivity_username_textInputLayout);
        userNameTextInputLayout = findViewById(R.id.signUpActivity_password_textInputLayout);
